      ...
      if (entries.length <= 0) {
        ...
        for (var i = 0; i < entries.length; i++) {
          ...
          if (entries[i].getElementsByTagName("EMP_STATUS")[0].childNodes[0].nodeValue == 'Active') {
            ...
            var net_id = entries[i].getAttribute("username");
