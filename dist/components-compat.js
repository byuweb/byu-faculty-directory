...
/***/function (module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.i, "/*!\r\n *  @license\r\n *    Copyright 2017 Brigham Young University\r\n *\r\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\r\n *    you may not use this file except in compliance with the License.\r\n *    You may obtain a copy of the License at\r\n *\r\n *        http://www.apache.org/licenses/LICENSE-2.0\r\n *\r\n *    Unless required by applicable law or agreed to in writing, software\r\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\r\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\r\n *    See the License for the specific language governing permissions and\r\n *    limitations under the License.\r\n */\n/*!\r\n *  @license\r\n *    Copyright 2017 Brigham Young University\r\n *\r\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\r\n *    you may not use this file except in compliance with the License.\r\n *    You may obtain a copy of the License at\r\n *\r\n *        http://www.apache.org/licenses/LICENSE-2.0\r\n *\r\n *    Unless required by applicable law or agreed to in writing, software\r\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\r\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\r\n *    See the License for the specific language governing permissions and\r\n *    limitations under the License.\r\n */.biography-slot-wrapper{height:194px;line-height:20px}#faculty-listing-column-middle ::slotted(h2){margin-top:0}.contact-wrapper{margin:36px 0 16px}.faculty-image{height:250px;vertical-align:middle;width:auto;border-radius:5px;box-shadow:4px 5px 2px -2px rgba(0,0,0,.2);-moz-box-shadow:rgba(0,0,0,.2) 4px 5px 2px -2px;-webkit-box-shadow:rgba(0,0,0,.2) 4px 5px 2px -2px}.hide{display:none}.listing-root{padding:16px;background-color:#fff;color:#515151;font-family:HCo Ringside Narrow SSm,Arial Narrow,sans-serif!important;font-weight:200!important;line-height:20px;margin:24px auto;min-width:274px;min-height:282px;vertical-align:top;border-radius:5px;box-shadow:1px 4px 2px -2px rgba(0,0,0,.2);-moz-box-shadow:rgba(0,0,0,.2) 1px 4px 2px -2px;-webkit-box-shadow:rgba(0,0,0,.2) 1px 4px 2px -2px}#faculty-listing-column-middle>a ::slotted(div),.listing-root ::slotted(h2){color:#002e5d;font-family:HCo Ringside Narrow SSm,Arial Narrow,sans-serif!important;margin:0}#faculty-listing-column-middle>a ::slotted(div){display:block;font-size:1.5em!important;font-weight:700!important}#faculty-listing-column-middle>a ::slotted(h2){color:#002e5d;font-family:HCo Ringside Narrow SSm,Arial Narrow,sans-serif!important;margin:0}.contact-wrapper>div ::slotted(p),.listing-root ::slotted(p),.slot>::slotted(p){margin:0}.adjusted-header{color:#002e5d;margin:0}.profile-link{text-decoration:none}.biography-slot-wrapper,.research-slot-wrapper{overflow:hidden}.research-slot-wrapper{line-height:20px;height:64px}.research-slot-wrapper>h3{margin-top:0}.section-header{color:#002e5d;margin:12px 0 0;margin:0;line-height:19px}.container-fluid{max-width:1032px;margin-right:auto;margin-left:auto}@media only screen and (max-width:1290px){.container-fluid{margin-right:10%;margin-left:10%}}@media only screen and (max-width:991px){.image-wrapper{margin:0 auto;padding-left:0}.container-fluid{margin-right:10%;margin-left:10%}}#faculty-listing-column-right{padding-right:40px}@media (min-width:631px){.col-sm-5{width:41.66666667%}}@media (min-width:992px){.col-md-3{width:25%}}@media only screen and (max-width:630px){.faculty-image{height:150px;width:auto}#faculty-listing-column-middle,.image-wrapper{text-align:center}.image-wrapper{margin:0 auto;padding-left:0;padding-bottom:10px}}", ""]);
...
/***/function (module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.i, "/*!\r\n *  @license\r\n *    Copyright 2017 Brigham Young University\r\n *\r\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\r\n *    you may not use this file except in compliance with the License.\r\n *    You may obtain a copy of the License at\r\n *\r\n *        http://www.apache.org/licenses/LICENSE-2.0\r\n *\r\n *    Unless required by applicable law or agreed to in writing, software\r\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\r\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\r\n *    See the License for the specific language governing permissions and\r\n *    limitations under the License.\r\n */\n/*!\r\n *  @license\r\n *    Copyright 2017 Brigham Young University\r\n *\r\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\r\n *    you may not use this file except in compliance with the License.\r\n *    You may obtain a copy of the License at\r\n *\r\n *        http://www.apache.org/licenses/LICENSE-2.0\r\n *\r\n *    Unless required by applicable law or agreed to in writing, software\r\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\r\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\r\n *    See the License for the specific language governing permissions and\r\n *    limitations under the License.\r\n */#background-image{display:none;overflow:hidden;max-height:0;height:0;opacity:0}.background-image-wrapper{background-position:50%;background-size:cover;height:300px;width:100%}.card{background-color:#fff;color:#515151;font-family:HCo Ringside Narrow SSm,Arial Narrow,sans-serif;font-weight:200;line-height:20px;margin:20px auto;max-width:824px;min-width:300px;border-radius:5px;box-shadow:1px 4px 2px -2px rgba(0,0,0,.2);-moz-box-shadow:rgba(0,0,0,.2) 1px 4px 2px -2px;-webkit-box-shadow:rgba(0,0,0,.2) 1px 4px 2px -2px}.card-chevron-wrapper{text-align:right;display:inline;float:right}.card-content{padding:8px 20px 16px;display:none;overflow:hidden;max-height:0;height:0;opacity:0}.card-title-wrapper ::slotted(h3){color:#002e5d;margin:0}.card-title-wrapper ::slotted(div){color:#002e5d;margin:0;font-size:1.17em;font-family:HCo Ringside Narrow SSm,Arial Narrow,sans-serif;font-weight:600;line-height:20px;display:inline}.card-content ::slotted(*){margin:0}.card-title-wrapper>h3{color:#002e5d;margin:0;display:inline}.card-title-wrapper{display:inline}.center-col{text-align:center;margin:0 auto}.click-area{padding:16px;transition:.2s ease-in-out;-webkit-transition:.2s ease-in-out;-moz-transition:.2s ease-in-out;-ms-transition:.2s ease-in-out;-o-transition:.2s ease-in-out}.click-area:hover{background-color:#c5c5c5;cursor:pointer}.chevron.svg-md{transition:.2s ease-in-out;-webkit-transition:.2s ease-in-out;-moz-transition:.2s ease-in-out;-ms-transition:.2s ease-in-out;-o-transition:.2s ease-in-out}.contact-wrapper{margin:32px 0 0}.container-fluid{padding:0}.content-wrapper{align-content:center;color:#fff;font-family:HCo Ringside Narrow SSm,Arial Narrow,sans-serif;font-weight:500;line-height:24px;margin:auto;text-shadow:4px 4px 8px #000;max-width:824px;height:300px;min-width:350px}.expanded>.card-content{display:block;max-height:500px;opacity:1;height:auto}.faculty-image{height:250px;width:auto;border-radius:5px;box-shadow:4px 5px 2px -2px rgba(0,0,0,.2);-moz-box-shadow:rgba(0,0,0,.2) 4px 5px 2px -2px;-webkit-box-shadow:rgba(0,0,0,.2) 4px 5px 2px -2px}.faculty-image-wrapper{padding-top:25px}.hide{display:none;overflow:hidden;max-height:0;height:0;opacity:0}.content-wrapper ::slotted(div),.content-wrapper ::slotted(h1){font-family:HCo Ringside Narrow SSm,Arial Narrow,sans-serif;margin:0 0 8px;font-weight:500}.content-wrapper ::slotted(div){display:block;font-size:2em}.svg-md{fill:#c1c1c1;height:24px;vertical-align:middle;width:24px}.svg-md:hover{cursor:pointer}.svg-shadow{-webkit-filter:drop-shadow(2px 2px 4px #000);filter:drop-shadow(2px 2px 4px #000000)}.svg-sm{fill:#fff;height:16px;vertical-align:middle;width:16px}.vertical-center-col{top:25px}@media only screen and (max-width:1050px){.card{margin-left:10%;margin-right:10%}}@media only screen and (max-width:475px){.faculty-image{height:175px}.faculty-image-wrapper{padding-top:62px}}", ""]);
...
/***/function (module, exports, __webpack_require__) {
  ...
  module.exports = "<link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css\" integrity=\"sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u\" crossorigin=\"anonymous\"> <style>/*" + __webpack_require__(10) + "*/</style> <div class=\"root listing-root container-fluid\"> <div class=\"row\"> <div id=\"faculty-listing-column-left\" class=\"col-md-3 col-sm-5 col-xs-12\"> <div class=\"image-wrapper\"> <a class=\"profile-link\" href=\"\"> <img class=\"faculty-image\" id=\"default-image\"> </a> </div> </div> <div id=\"faculty-listing-column-middle\" class=\"col-md-3 col-sm-5 col-xs-12\"> <a class=\"profile-link\" href=\"\"> <slot id=\"listing-name\" name=\"listing-name\"></slot> </a> <i><slot name=\"listing-title\"></slot></i> <div class=\"contact-wrapper\"> <div class=\"office-slot-wrapper\"> <b>Office: </b><slot name=\"listing-office\"></slot> </div> <div class=\"phone-slot-wrapper\"> <b>Phone: </b><slot name=\"listing-phone\"></slot> </div> <div class=\"email-slot-wrapper\"> <b>Email: </b><slot name=\"listing-email\"></slot> </div> </div> <div class=\"office-hours-slot-wrapper\"> <b>Office Hours: </b><br> <slot name=\"listing-office-hours\"></slot> </div> </div> <div id=\"faculty-listing-column-right\" class=\"col-md-6 visible-lg visible-md\"> <div class=\"research-slot-wrapper\"> <h3 class=\"section-header\">Research</h3> <div class=\"slot\"> <slot name=\"listing-research\"></slot> </div> </div> <div class=\"biography-slot-wrapper\"> <h3 class=\"section-header\">Biography</h3> <div class=\"slot\"> <slot name=\"listing-biography\"></slot> </div> </div> </div> </div> </div>";
