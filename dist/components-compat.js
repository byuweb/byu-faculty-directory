...
/***/function (module, __webpack_exports__, __webpack_require__) {
  ...
  function applyBackgroundImage(component) {
    ...
    var facultyName = component.shadowRoot.querySelector('slot#faculty-name');
    if (table) {
