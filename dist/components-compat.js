...
/***/function (module, exports, __webpack_require__) {
  ...
  // module
  exports.push([module.i, "/*!\n *  @license\n *    Copyright 2017 Brigham Young University\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */\n/*!\n *  @license\n *    Copyright 2017 Brigham Young University\n *\n *    Licensed under the Apache License, Version 2.0 (the \"License\");\n *    you may not use this file except in compliance with the License.\n *    You may obtain a copy of the License at\n *\n *        http://www.apache.org/licenses/LICENSE-2.0\n *\n *    Unless required by applicable law or agreed to in writing, software\n *    distributed under the License is distributed on an \"AS IS\" BASIS,\n *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.\n *    See the License for the specific language governing permissions and\n *    limitations under the License.\n */#background-image{display:none}.background-image-wrapper{background-position:50%;background-size:cover;height:300px;width:100%}.card{background-color:#fff;font-family:Gotham A,Gotham B,Helvetica,sans-serif;margin:20px auto 0;width:100%;max-width:824px;-moz-box-shadow:8px 8px 16px 1px rgba(0,0,0,.2);-webkit-box-shadow:8px 8px 16px 1px rgba(0,0,0,.2);box-shadow:8px 8px 16px 1px rgba(0,0,0,.2)}.card-chevron-wrapper{text-align:right}.card-content{padding:0 16px 16px;display:none}.card-content ::slotted(*){margin:0}.card-title-wrapper>h3{color:#002e5d;margin:0}.click-area{padding:16px}.click-area:hover{background-color:#c5c5c5;cursor:pointer}.click-area>table{width:100%}.contact-wrapper{margin:32px 0 0}.content-wrapper{align-content:center;color:#fff;font-family:Gotham A,Gotham B,Helvetica,sans-serif;font-weight:700;line-height:24px;margin:auto;width:848px}.expanded>.card-content{display:block}.faculty-image{height:250px;margin:8px 0 0;width:auto}#hidden-image{display:none}#left-column{width:170px;padding:16px 16px 16px 0}.profile-root{height:600px}.profile-root ::slotted(h1){font-family:Vitesse A,Vitesse B,Georgia,serif;margin:0 0 8px}#right-column{vertical-align:middle;padding:16px 16px 16px 0}.svg-md{fill:#c1c1c1;height:24px;vertical-align:middle;width:24px}.svg-md:hover{cursor:pointer}.svg-sm{fill:#fff;height:16px;vertical-align:middle;width:16px}@media only screen and (max-width:859px){.card{width:456px}.content-wrapper{width:480px}}@media only screen and (max-width:491px){.card{width:290px}.contact-wrapper{margin:16px}.content-wrapper{line-height:18px;text-align:center;width:100%}#default-image,#left-column{display:none}#hidden-image{height:140px;margin:auto;padding:16px 0 8px;width:auto;display:block}}", ""]);
...
/***/function (module, exports, __webpack_require__) {
  ...
  module.exports = "<style>" + __webpack_require__(11) + "</style> <div class=\"root profile-root\"> <div class=\"background-image-wrapper\"> <div> <div class=\"faculty-image-wrapper\"> <img class=\"faculty-image\" id=\"hidden-image\" src=\"xxxHTMLLINKxxx0.175745282727266080.9386934725641483xxx\" alt=\"Faculty Image\"> </div> <table class=\"content-wrapper\"> <tr> <td id=\"left-column\"> <div class=\"faculty-image-wrapper\"> <img class=\"faculty-image\" id=\"default-image\" src=\"xxxHTMLLINKxxx0.6422773140684850.5364878595623337xxx\" alt=\"Faculty Image\"> </div> </td> <td id=\"right-column\"> <slot id=\"faculty-name\" name=\"faculty-name\"></slot> <i><slot name=\"faculty-title\"></slot></i> <div class=\"contact-wrapper\"> <div class=\"office-slot-wrapper\"> <span><img class=\"svg-sm\" src=\"" + __webpack_require__(16) + "\" alt=\"Desk\"> Office: <slot name=\"faculty-office\"></slot></span> </div> <div class=\"email-slot-wrapper\"> <span><img class=\"svg-sm\" src=\"" + __webpack_require__(17) + "\" alt=\"Email\"> Email: <slot name=\"faculty-email\"></slot></span> </div> <div class=\"phone-slot-wrapper\"> <span><img class=\"svg-sm\" src=\"" + __webpack_require__(15) + "\" alt=\"Phone\"> Phone: <slot name=\"faculty-phone\"></slot></span> </div> </div> </td> </tr> </table> </div> </div> <div class=\"additional-info-wrapper\"> <div class=\"card biography-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Biography</h3> </td> <td class=\"card-chevron-wrapper\"> <img id=\"chevron\" class=\"chevron svg-md\" src=\"/components/byu-faculty-profile/Chevron-Right.svg\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-biography\">No Information</slot> </div> </div> <div class=\"card research-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Research</h3> </td> <td class=\"card-chevron-wrapper\"> <img class=\"chevron svg-md\" src=\"" + __webpack_require__(0) + "\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-research\">No Information</slot> </div> </div> <div class=\"card committees-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Committees</h3> </td> <td class=\"card-chevron-wrapper\"> <img class=\"chevron svg-md\" src=\"" + __webpack_require__(0) + "\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-committees\">No Information</slot> </div> </div> <div class=\"card papers-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Papers</h3> </td> <td class=\"card-chevron-wrapper\"> <img class=\"chevron svg-md\" src=\"" + __webpack_require__(0) + "\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-papers\">No Information</slot> </div> </div> <div class=\"card awards-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Awards</h3> </td> <td class=\"card-chevron-wrapper\"> <img class=\"chevron svg-md\" src=\"" + __webpack_require__(0) + "\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-awards\">No Information</slot> </div> </div> <div class=\"card courses-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Courses</h3> </td> <td class=\"card-chevron-wrapper\"> <img class=\"chevron svg-md\" src=\"" + __webpack_require__(0) + "\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-courses\">No Information</slot> </div> </div> <div class=\"card office-hours-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Office Hours</h3> </td> <td class=\"card-chevron-wrapper\"> <img class=\"chevron svg-md\" src=\"" + __webpack_require__(0) + "\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-office-hours\">No Information</slot> </div> </div> <div class=\"card links-card\"> <div class=\"click-area\"> <table> <tbody> <tr> <td class=\"card-title-wrapper\"> <h3>Links</h3> </td> <td class=\"card-chevron-wrapper\"> <img class=\"chevron svg-md\" src=\"" + __webpack_require__(0) + "\"> </td> </tr> </tbody> </table> </div> <div class=\"card-content\"> <slot name=\"faculty-links\">No Information</slot> </div> </div> </div> </div>";
