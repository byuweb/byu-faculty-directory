...
function applyBackgroundImage(component) {
  ...
  //Allow font of faculty name to be inherited
  let facultyName = component.shadowRoot.querySelector('div.faculty-name');
  console.log(facultyName);
  if(facultyName) {
    facultyName.style['font-size'] = '28px';
